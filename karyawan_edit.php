...
<?php 
	include 'koneksi.php';
	$NIP = $_GET['NIP'];
	$data = mysqli_query($koneksi, "SELECT * FROM tb_pegawai WHERE NIP = '$NIP'");
...
<form action="proedit_karyawan.php" method="POST" enctype="multipart/form-data">
  ...
  <input type="text" class="form-control" readonly="" name="NIP" autocomplete="off" value="<?php echo $d['NIP'];?>">
