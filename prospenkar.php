                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="Pegawai_edit.php?NIP=<?php echo $row['NIP']; ?>"><button class="btn btn-primary">Ubah</button></a> <a href="hapus.php?NIP=<?php echo $row['NIP']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
