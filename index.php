        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              ...
              <p>Aplikasi Kepegawaian ini meliputi informasi mengenai para pegawai pada DISKOMINFO Kota Semarang</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">Sulistyani </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
    ...
    <section class="section-margin">
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        ...
        <ul class="list-inline" id="chart-skill">
          <li><a href="login.php" target="_blank"><button class="btn btn-warning" style="size: 300px;">Masuk</button></a>
          </li><br>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Sulistyani</a>
