                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="prospenab.php" method="POST">
                                <input autocomplete="off" class="au-input au-input--xl" type="text" name="cari" placeholder="Cari NIP atau Nama Pegawai" />
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> <a href="absen/hapus_absen.php?NIP=<?php echo $row['NIP']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
